...
<div id="wrapper">
    ...
    <div class="topbar">
        ...
        <div class="topbar-left">
            <div class="text-center">
                <a href="" class="logo">i<i class="icon-c-logo"></i><span>o<i class="md md-a"></i>t</span></a>
            </div>
        </div>
        ...
        <div class="sidebar-inner slimscrollleft">
            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    {{--                            <a href="{{route('admin_service.index')}}" class="waves-effect"><i class="fa fa-briefcase "></i> <span> Services </span></a>--}}
                    ...
                    <li>
                        ...
                        {{--                        <a href="{{route('product.index')}}" class="waves-effect"><i class="fa fa-list"></i> <span>Products</span></a>--}}
    ...
    <div class="content-page">
        ...
        <footer class="footer text-right">
            Iot &copy; 2020 All rights reserved.
        </footer>
    </div>
    <!-- ============================================================== -->
